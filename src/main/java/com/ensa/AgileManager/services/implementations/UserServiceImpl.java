...
import com.ensa.AgileManager.exceptions.UserNotFoundException;
import com.ensa.AgileManager.mappers.UserMapper;
import com.ensa.AgileManager.repositories.UserRepository;
import com.ensa.AgileManager.services.JwtService;
...
public class UserServiceImpl implements UserService {
    ...
    public User saveUser(UserDto user) {
        ...
        return userRepository.save(UserMapper.INSTANCE.toEntity(user));
    }
